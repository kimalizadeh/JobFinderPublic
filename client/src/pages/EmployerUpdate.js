...
function EmployerUpdate({preloadedValues}) {
    let { id } = useParams();
    ...
    const onSubmit = (data) => {
        ...
        axios.put(`https://jobfinder-fsd01.herokuapp.com/jobs/employer/${id}`, data,
    ...
    <div className="container">
            ...
            <span className="text-danger form-text">{error}</span>
                ...
                <CKEditor data={ckDescription} editor={ClassicEditor} onInit={editor=> {}} config={{removePlugins: ["EasyImage","ImageUpload","MediaEmbed"]}}
